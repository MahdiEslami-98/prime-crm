        ...
        <div className="flex flex-col gap-y-[149px]">
          ...
          <div className="grid grid-rows-3 xl:grid-cols-12 xl:grid-rows-1">
            ...
            <div className="row-span-11 flex flex-col gap-y-[32px] pl-4 md:row-span-2 xl:col-span-9">
              <p className="font-open-sans text-head6">
                ...
                repellat repudiandae. Voluptate at dolores ut dolor sint
          ...
          <div className="grid grid-rows-3 md:grid-cols-12 md:grid-rows-1">
            ...
            <div className="row-span-2 pl-4 md:col-span-9 md:row-span-11">
              {list.map((item, index) => (
                <div
                  className="flex items-center gap-x-[11px] py-3"
                  key={index}
                >
            ...
            <div className="row-span-2 flex flex-col flex-wrap gap-y-[50px] pl-4 md:col-span-9 md:row-span-1">
              <div className="flex justify-center gap-x-[20px] md:justify-start">
                <Button
                  text="Default"
                  color="bg-primary-03"
                  className="px-[59px] py-[14px] text-head6 font-semibold text-white dark:bg-primary-02 dark:text-primary-03"
                />
                <Button
                  text="Default"
                  color="bg-primary-04"
                  className="px-[59px] py-[14px] text-head6 font-semibold text-primary-03"
                />
              </div>
          ...
          <div className="grid grid-rows-7 pb-[149px] md:grid-cols-12 md:grid-rows-1">
            ...
            <div className="row-span-5 flex flex-col gap-y-[30px] pl-4 md:col-span-9 md:row-span-1">
              <div className="inline-flex items-center justify-center gap-x-[33px] dark:rounded-[5px] dark:bg-white md:justify-start">
